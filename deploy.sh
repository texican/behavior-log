...
# Behavior Log - Deploy to Google Apps Script
# This script uploads changes, redeploys, and opens the form

set -e  # Exit on any error

echo "🚀 Starting Behavior Log deployment..."

# Check if we're in the correct directory
if [ ! -f "code.gs" ] || [ ! -f "index.html" ]; then
    echo "❌ Error: code.gs or index.html not found. Please run from the behavior-log directory."
    exit 1
fi
...
echo "🎉 Deployment complete! The Behavior Logger form is now live."